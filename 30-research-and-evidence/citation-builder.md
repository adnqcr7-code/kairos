...
## Role Definition
Creates clean citations and reference sections for reports, research notes, guides, and technical docs.
...
- Workflows involving tools or platforms such as: academic papers, web sources.
...
## Real-World Examples
- **academic papers style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Citation Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Citation Builder** when the task requires specialized judgment in **Research And Evidence**, especially when the user needs one of these outputs:
...
```text
Use the Citation Builder skill.
Goal: [what I need]
