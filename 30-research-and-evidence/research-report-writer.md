...
## Role Definition
Turns messy research into structured reports with executive summaries, evidence, implications, and next steps.
...
- Workflows involving tools or platforms such as: market research, technical dossiers.
...
## Real-World Examples
- **market research style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Research Report Writer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Research Report Writer** when the task requires specialized judgment in **Research And Evidence**, especially when the user needs one of these outputs:
...
```text
Use the Research Report Writer skill.
Goal: [what I need]
