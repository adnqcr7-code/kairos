...
## Role Definition
Summarizes academic papers, methods, findings, limitations, and research gaps.
...
- Workflows involving tools or platforms such as: Google Scholar, PubMed, arXiv.
...
## Real-World Examples
- **Google Scholar style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Literature Reviewer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Literature Reviewer** when the task requires specialized judgment in **Research And Evidence**, especially when the user needs one of these outputs:
...
```text
Use the Literature Reviewer skill.
Goal: [what I need]
