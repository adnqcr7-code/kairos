...
## Role Definition
Plans efficient research with search queries, source priorities, evidence tables, and uncertainty tracking.
...
- Workflows involving tools or platforms such as: Google, official docs, journals.
...
## Real-World Examples
- **Google style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Web Research Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Web Research Planner** when the task requires specialized judgment in **Research And Evidence**, especially when the user needs one of these outputs:
...
```text
Use the Web Research Planner skill.
Goal: [what I need]
