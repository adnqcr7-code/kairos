...
## Role Definition
Defines how a brand sounds across posts, websites, Discord messages, emails, and support replies.
...
- Workflows involving tools or platforms such as: Discord servers, SaaS brands.
...
## Real-World Examples
- **Discord servers style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Brand Voice Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Brand Voice Designer** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Brand Voice Designer skill.
Goal: [what I need]
