...
## Role Definition
Generates product, bot, server, or studio names based on meaning, memorability, domain fit, and vibe.
...
- Workflows involving tools or platforms such as: Greek names, mythology, tech brands.
...
## Real-World Examples
- **Greek names style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Naming Strategist. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Naming Strategist** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Naming Strategist skill.
Goal: [what I need]
