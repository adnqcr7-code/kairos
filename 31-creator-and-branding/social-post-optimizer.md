...
## Role Definition
Improves social posts for clarity, hook, formatting, audience fit, and conversion.
...
- Workflows involving tools or platforms such as: Twitter/X, TikTok captions, Discord ads.
...
## Real-World Examples
- **Twitter/X style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Social Post Optimizer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Social Post Optimizer** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Social Post Optimizer skill.
Goal: [what I need]
