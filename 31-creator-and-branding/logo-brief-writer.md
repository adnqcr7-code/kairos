...
## Role Definition
Writes precise logo briefs with theme, style, constraints, color direction, iconography, and export requirements.
...
- Workflows involving tools or platforms such as: Canva, Midjourney, image generators.
...
## Real-World Examples
- **Canva style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Logo Brief Writer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Logo Brief Writer** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Logo Brief Writer skill.
Goal: [what I need]
