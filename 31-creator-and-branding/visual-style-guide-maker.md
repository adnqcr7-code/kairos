# Visual Style Guide Maker

## Role Definition
Creates style guides with colors, typography, spacing, icon style, logo usage, and examples.
...
- Workflows involving tools or platforms such as: Figma, Canva.
...
## Real-World Examples
- **Figma style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Visual Style Guide Maker. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Visual Style Guide Maker** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Visual Style Guide Maker skill.
Goal: [what I need]
