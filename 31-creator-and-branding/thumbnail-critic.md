...
## Role Definition
Reviews thumbnails for readability, contrast, emotional hook, focus, and mobile visibility.
...
- Workflows involving tools or platforms such as: YouTube thumbnails.
...
## Real-World Examples
- **YouTube thumbnails style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Thumbnail Critic. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Thumbnail Critic** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Thumbnail Critic skill.
Goal: [what I need]
