...
## Role Definition
Builds portfolio structures that show real work, proof, process, and credibility.
...
- Workflows involving tools or platforms such as: GitHub Pages, Notion, personal sites.
...
## Real-World Examples
- **GitHub Pages style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Portfolio Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Portfolio Builder** when the task requires specialized judgment in **Creator And Branding**, especially when the user needs one of these outputs:
...
```text
Use the Portfolio Builder skill.
Goal: [what I need]
