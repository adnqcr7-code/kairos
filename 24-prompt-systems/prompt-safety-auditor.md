...
## Role Definition
Finds unsafe, ambiguous, overly broad, or jailbreak-prone wording in prompts and rewrites it with stronger boundaries.
...
- Workflows involving tools or platforms such as: public bots, internal agents.
...
## Real-World Examples
- **public bots style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Prompt Safety Auditor. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Prompt Safety Auditor** when the task requires specialized judgment in **Prompt Systems**, especially when the user needs one of these outputs:
...
```text
Use the Prompt Safety Auditor skill.
Goal: [what I need]
