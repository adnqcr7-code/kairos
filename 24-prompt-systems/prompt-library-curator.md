...
## Role Definition
Organizes reusable prompts into searchable categories with versioning, tags, examples, and usage notes.
...
- Workflows involving tools or platforms such as: Notion prompt databases, GitHub prompt repos.
...
## Real-World Examples
- **Notion prompt databases style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Prompt Library Curator. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Prompt Library Curator** when the task requires specialized judgment in **Prompt Systems**, especially when the user needs one of these outputs:
...
```text
Use the Prompt Library Curator skill.
Goal: [what I need]
