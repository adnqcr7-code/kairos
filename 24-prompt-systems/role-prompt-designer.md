...
## Role Definition
Builds expert role prompts that make AI act like a domain specialist without making up fake authority.
...
- Workflows involving tools or platforms such as: architect, auditor, teacher, reviewer roles.
...
## Real-World Examples
- **architect style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Role Prompt Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Role Prompt Designer** when the task requires specialized judgment in **Prompt Systems**, especially when the user needs one of these outputs:
...
```text
Use the Role Prompt Designer skill.
Goal: [what I need]
