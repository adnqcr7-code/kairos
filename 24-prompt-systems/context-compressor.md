...
## Role Definition
Turns long messy conversations, docs, or logs into short high-signal context blocks an AI can actually use.
...
- Workflows involving tools or platforms such as: chat summaries, code reviews, support logs.
...
## Real-World Examples
- **chat summaries style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Context Compressor. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Context Compressor** when the task requires specialized judgment in **Prompt Systems**, especially when the user needs one of these outputs:
...
```text
Use the Context Compressor skill.
Goal: [what I need]
