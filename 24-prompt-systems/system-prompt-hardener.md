...
## Role Definition
Strengthens system prompts for reliability, refusal behavior, citation rules, tool rules, and output formatting.
...
- Workflows involving tools or platforms such as: AI assistants, Discord bots, browser agents.
...
## Real-World Examples
- **AI assistants style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the System Prompt Hardener. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **System Prompt Hardener** when the task requires specialized judgment in **Prompt Systems**, especially when the user needs one of these outputs:
...
```text
Use the System Prompt Hardener skill.
Goal: [what I need]
