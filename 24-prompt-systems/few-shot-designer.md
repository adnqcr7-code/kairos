...
## Role Definition
Creates high-quality examples that teach a model the exact format, reasoning style, and constraints needed for a task.
...
- Workflows involving tools or platforms such as: classification, extraction, writing templates.
...
## Real-World Examples
- **classification style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Few Shot Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Few Shot Designer** when the task requires specialized judgment in **Prompt Systems**, especially when the user needs one of these outputs:
...
```text
Use the Few Shot Designer skill.
Goal: [what I need]
