...
## Role Definition
Finds speed issues related to images, JavaScript, caching, fonts, hydration, and database calls.
...
- Workflows involving tools or platforms such as: Lighthouse, PageSpeed Insights.
...
## Real-World Examples
- **Lighthouse style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Web Performance Auditor. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Web Performance Auditor** when the task requires specialized judgment in **Web Apps Fullstack**, especially when the user needs one of these outputs:
...
```text
Use the Web Performance Auditor skill.
Goal: [what I need]
