# Payment Integration Planner

## Role Definition
Plans payment flows, checkout pages, webhooks, subscription states, cancellations, and billing edge cases.
...
- Workflows involving tools or platforms such as: Stripe, Lemon Squeezy.
...
## Real-World Examples
- **Stripe style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Payment Integration Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Payment Integration Planner** when the task requires specialized judgment in **Web Apps Fullstack**, especially when the user needs one of these outputs:
...
```text
Use the Payment Integration Planner skill.
Goal: [what I need]
