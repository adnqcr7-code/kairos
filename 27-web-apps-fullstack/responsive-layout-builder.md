...
## Role Definition
Creates layouts that work on mobile, tablet, and desktop without becoming a visual crime scene.
...
- Workflows involving tools or platforms such as: Tailwind CSS, CSS Grid, Flexbox.
...
## Real-World Examples
- **Tailwind CSS style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Responsive Layout Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Responsive Layout Builder** when the task requires specialized judgment in **Web Apps Fullstack**, especially when the user needs one of these outputs:
...
```text
Use the Responsive Layout Builder skill.
Goal: [what I need]
