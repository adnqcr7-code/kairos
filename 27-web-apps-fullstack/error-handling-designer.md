...
## Role Definition
Creates error handling patterns for UI, APIs, logs, retries, user messages, and developer debugging.
...
- Workflows involving tools or platforms such as: Sentry, console logs, try/catch.
...
## Real-World Examples
- **Sentry style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Error Handling Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Error Handling Designer** when the task requires specialized judgment in **Web Apps Fullstack**, especially when the user needs one of these outputs:
...
```text
Use the Error Handling Designer skill.
Goal: [what I need]
