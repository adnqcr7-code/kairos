...
## Role Definition
Diagnoses failed deploys by checking build logs, dependencies, environment variables, routes, runtime versions, and platform limits.
...
- Workflows involving tools or platforms such as: Vercel, Netlify, Render.
...
## Real-World Examples
- **Vercel style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Deployment Fixer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Deployment Fixer** when the task requires specialized judgment in **Web Apps Fullstack**, especially when the user needs one of these outputs:
...
```text
Use the Deployment Fixer skill.
Goal: [what I need]
