...
## Role Definition
Designs forms with validation, error messages, accessibility, spam prevention, and clean submission states.
...
- Workflows involving tools or platforms such as: Zod, React Hook Form.
...
## Real-World Examples
- **Zod style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Form Validation Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Form Validation Designer** when the task requires specialized judgment in **Web Apps Fullstack**, especially when the user needs one of these outputs:
...
```text
Use the Form Validation Designer skill.
Goal: [what I need]
