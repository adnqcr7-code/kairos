...
## Role Definition
Designs NPC dialogue, quests, objectives, rewards, and progression gates.
...
- Workflows involving tools or platforms such as: Roblox RPGs, quest systems.
...
## Real-World Examples
- **Roblox RPGs style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Npc Quest Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Npc Quest Designer** when the task requires specialized judgment in **Roblox Game Dev**, especially when the user needs one of these outputs:
...
```text
Use the Npc Quest Designer skill.
Goal: [what I need]
