...
## Role Definition
Balances rewards, currencies, upgrades, progression, cooldowns, and anti-farming systems.
...
- Workflows involving tools or platforms such as: Roblox games, simulators.
...
## Real-World Examples
- **Roblox games style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Game Economy Balancer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Game Economy Balancer** when the task requires specialized judgment in **Roblox Game Dev**, especially when the user needs one of these outputs:
...
```text
Use the Game Economy Balancer skill.
Goal: [what I need]
