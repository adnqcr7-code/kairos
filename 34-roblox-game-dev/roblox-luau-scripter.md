...
## Role Definition
Writes Roblox Luau scripts for gameplay, UI, events, tools, and server-client communication.
...
- Workflows involving tools or platforms such as: Roblox Studio, Luau.
...
## Real-World Examples
- **Roblox Studio style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Roblox Luau Scripter. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Roblox Luau Scripter** when the task requires specialized judgment in **Roblox Game Dev**, especially when the user needs one of these outputs:
...
```text
Use the Roblox Luau Scripter skill.
Goal: [what I need]
