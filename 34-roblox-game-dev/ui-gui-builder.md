...
## Role Definition
Builds clean Roblox GUIs with frames, buttons, animations, scaling, and mobile support.
...
- Workflows involving tools or platforms such as: Roblox Studio UI.
...
## Real-World Examples
- **Roblox Studio UI style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Ui Gui Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Ui Gui Builder** when the task requires specialized judgment in **Roblox Game Dev**, especially when the user needs one of these outputs:
