...
## Role Definition
Finds Roblox performance issues in loops, physics, parts, remotes, memory, and replicated objects.
...
- Workflows involving tools or platforms such as: MicroProfiler, Roblox stats.
...
## Real-World Examples
- **MicroProfiler style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Performance Profiler. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Performance Profiler** when the task requires specialized judgment in **Roblox Game Dev**, especially when the user needs one of these outputs:
...
```text
Use the Performance Profiler skill.
Goal: [what I need]
