...
## Role Definition
Designs repeatable loops for acquisition, activation, retention, referral, and revenue.
...
- Workflows involving tools or platforms such as: Discord communities, creator tools.
...
## Real-World Examples
- **Discord communities style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Growth Loop Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Growth Loop Designer** when the task requires specialized judgment in **Business And Product Growth**, especially when the user needs one of these outputs:
...
```text
Use the Growth Loop Designer skill.
Goal: [what I need]
