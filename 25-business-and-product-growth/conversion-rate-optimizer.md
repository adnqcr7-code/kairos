...
## Role Definition
Improves sign-up, purchase, and onboarding flows by reducing friction and testing better copy, layout, and calls to action.
...
## Best Used For
- Tasks in the **Business And Product Growth** domain that need structured expert judgment.
- Situations where the user wants a concrete plan, implementation details, review, or improvement path.
- Workflows involving tools or platforms such as: Shopify, Airbnb-style booking flows.
...
## Real-World Examples
- **Shopify style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Conversion Rate Optimizer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Conversion Rate Optimizer** when the task requires specialized judgment in **Business And Product Growth**, especially when the user needs one of these outputs:
...
```text
Use the Conversion Rate Optimizer skill.
Goal: [what I need]
