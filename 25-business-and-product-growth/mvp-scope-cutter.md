...
## Role Definition
Cuts bloated product plans down to the smallest usable version that can be built, tested, and sold quickly.
...
- Workflows involving tools or platforms such as: AI tools, dashboards, extensions.
...
## Real-World Examples
- **AI tools style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Mvp Scope Cutter. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Mvp Scope Cutter** when the task requires specialized judgment in **Business And Product Growth**, especially when the user needs one of these outputs:
...
```text
Use the Mvp Scope Cutter skill.
Goal: [what I need]
