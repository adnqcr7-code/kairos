...
## Role Definition
Creates clear service offers with deliverables, prices, terms, examples, and proof so people understand what they are buying.
...
- Workflows involving tools or platforms such as: Discord bot services, web design offers.
...
## Real-World Examples
- **Discord bot services style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Offer Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Offer Builder** when the task requires specialized judgment in **Business And Product Growth**, especially when the user needs one of these outputs:
