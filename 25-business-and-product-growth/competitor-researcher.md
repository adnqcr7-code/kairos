...
## Role Definition
Finds competitors, compares features and pricing, and identifies gaps a small builder can realistically attack.
...
- Workflows involving tools or platforms such as: Google search, Product Hunt, G2.
...
## Real-World Examples
- **Google search style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Competitor Researcher. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Competitor Researcher** when the task requires specialized judgment in **Business And Product Growth**, especially when the user needs one of these outputs:
...
```text
Use the Competitor Researcher skill.
Goal: [what I need]
