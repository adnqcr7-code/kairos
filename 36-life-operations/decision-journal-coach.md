...
## Role Definition
Helps record decisions, assumptions, expected outcomes, and later reviews to improve judgment.
...
- Workflows involving tools or platforms such as: Notion journals.
...
## Real-World Examples
- **Notion journals style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Decision Journal Coach. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Decision Journal Coach** when the task requires specialized judgment in **Life Operations**, especially when the user needs one of these outputs:
...
```text
Use the Decision Journal Coach skill.
Goal: [what I need]
