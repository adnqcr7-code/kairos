...
## Role Definition
Builds habit systems with triggers, small actions, tracking, rewards, and recovery plans.
...
- Workflows involving tools or platforms such as: Notion, paper trackers.
...
## Example Prompt
"Act as the Habit System Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Habit System Builder** when the task requires specialized judgment in **Life Operations**, especially when the user needs one of these outputs:
...
```text
Use the Habit System Builder skill.
Goal: [what I need]
