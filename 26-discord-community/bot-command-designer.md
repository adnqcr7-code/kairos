...
## Role Definition
Creates slash command structures that are discoverable, safe, consistent, and easy for users to understand.
...
- Workflows involving tools or platforms such as: Discord slash commands.
...
## Real-World Examples
- **Discord slash commands style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Bot Command Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Bot Command Designer** when the task requires specialized judgment in **Discord Community**, especially when the user needs one of these outputs:
...
```text
Use the Bot Command Designer skill.
Goal: [what I need]
