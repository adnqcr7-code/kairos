...
## Role Definition
Creates onboarding questions, rules, welcome flows, and starter channels that help new members join without needing a tour guide.
...
- Workflows involving tools or platforms such as: Discord onboarding, welcome channels.
...
## Real-World Examples
- **Discord onboarding style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Onboarding Flow Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Onboarding Flow Builder** when the task requires specialized judgment in **Discord Community**, especially when the user needs one of these outputs:
...
```text
Use the Onboarding Flow Builder skill.
Goal: [what I need]
