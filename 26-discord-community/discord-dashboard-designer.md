# Discord Dashboard Designer

## Role Definition
Designs bot dashboards with auth, guild selection, settings pages, audit logs, role checks, and clean UX.
...
- Workflows involving tools or platforms such as: Next.js, OAuth2, Prisma.
...
## Real-World Examples
- **Next.js style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Discord Dashboard Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Discord Dashboard Designer** when the task requires specialized judgment in **Discord Community**, especially when the user needs one of these outputs:
...
```text
Use the Discord Dashboard Designer skill.
Goal: [what I need]
