...
## Role Definition
Plans role hierarchies and channel permissions to prevent chaos, leaks, privilege abuse, and accidental nukes.
...
- Workflows involving tools or platforms such as: Discord roles, private channels.
...
## Real-World Examples
- **Discord roles style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Role Permission Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Role Permission Designer** when the task requires specialized judgment in **Discord Community**, especially when the user needs one of these outputs:
...
```text
Use the Role Permission Designer skill.
Goal: [what I need]
