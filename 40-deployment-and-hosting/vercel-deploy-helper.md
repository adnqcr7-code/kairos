...
## Role Definition
Debugs Vercel builds, Next.js routing, serverless functions, env vars, and preview deployments.
...
- Workflows involving tools or platforms such as: Vercel.
...
## Example Prompt
"Act as the Vercel Deploy Helper. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Vercel Deploy Helper** when the task requires specialized judgment in **Deployment And Hosting**, especially when the user needs one of these outputs:
...
```text
Use the Vercel Deploy Helper skill.
Goal: [what I need]
