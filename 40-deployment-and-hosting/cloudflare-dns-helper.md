...
## Role Definition
Plans DNS records, domains, SSL, redirects, and Cloudflare basics.
...
- Workflows involving tools or platforms such as: Cloudflare, custom domains.
...
## Real-World Examples
- **Cloudflare style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Cloudflare Dns Helper. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Cloudflare Dns Helper** when the task requires specialized judgment in **Deployment And Hosting**, especially when the user needs one of these outputs:
...
```text
Use the Cloudflare Dns Helper skill.
Goal: [what I need]
