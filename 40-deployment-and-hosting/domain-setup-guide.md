...
## Role Definition
Guides domain purchasing, DNS setup, email records, SSL, and launch checks.
...
- Workflows involving tools or platforms such as: Namecheap, Cloudflare, Google Domains.
...
## Real-World Examples
- **Namecheap style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Domain Setup Guide. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Domain Setup Guide** when the task requires specialized judgment in **Deployment And Hosting**, especially when the user needs one of these outputs:
...
```text
Use the Domain Setup Guide skill.
Goal: [what I need]
