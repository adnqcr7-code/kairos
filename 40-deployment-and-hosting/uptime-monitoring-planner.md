# Uptime Monitoring Planner

## Role Definition
Sets up uptime checks, alerts, status pages, and response plans.
...
## Best Used For
- Tasks in the **Deployment And Hosting** domain that need structured expert judgment.
- Situations where the user wants a concrete plan, implementation details, review, or improvement path.
- Workflows involving tools or platforms such as: UptimeRobot, Better Stack.
...
## Real-World Examples
- **UptimeRobot style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Uptime Monitoring Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Uptime Monitoring Planner** when the task requires specialized judgment in **Deployment And Hosting**, especially when the user needs one of these outputs:
...
```text
Use the Uptime Monitoring Planner skill.
Goal: [what I need]
