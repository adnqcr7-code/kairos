...
## Role Definition
Debugs Netlify builds, environment variables, redirects, functions, and deploy previews.
...
- Workflows involving tools or platforms such as: Netlify.
...
## Real-World Examples
- **Netlify style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Netlify Deploy Helper. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Netlify Deploy Helper** when the task requires specialized judgment in **Deployment And Hosting**, especially when the user needs one of these outputs:
...
```text
Use the Netlify Deploy Helper skill.
Goal: [what I need]
