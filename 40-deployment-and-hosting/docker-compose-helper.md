...
## Role Definition
Builds Docker Compose setups for local development with app, database, cache, and worker services.
...
- Workflows involving tools or platforms such as: Docker, PostgreSQL, Redis.
...
## Real-World Examples
- **Docker style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Docker Compose Helper. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Docker Compose Helper** when the task requires specialized judgment in **Deployment And Hosting**, especially when the user needs one of these outputs:
...
```text
Use the Docker Compose Helper skill.
Goal: [what I need]
