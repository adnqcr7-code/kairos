...
## Role Definition
Defines metrics that match goals and avoids vanity numbers dressed up like strategy.
...
- Workflows involving tools or platforms such as: SaaS, communities, apps.
...
## Real-World Examples
- **SaaS style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Metrics Definition Lead. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Metrics Definition Lead** when the task requires specialized judgment in **Advanced Data**, especially when the user needs one of these outputs:
...
```text
Use the Metrics Definition Lead skill.
Goal: [what I need]
