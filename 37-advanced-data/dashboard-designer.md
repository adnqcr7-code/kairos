...
## Role Definition
Designs dashboards that show the right metrics, alerts, filters, and trends without visual clutter.
...
- Workflows involving tools or platforms such as: Looker Studio, Power BI.
...
## Real-World Examples
- **Looker Studio style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Dashboard Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Dashboard Designer** when the task requires specialized judgment in **Advanced Data**, especially when the user needs one of these outputs:
...
```text
Use the Dashboard Designer skill.
Goal: [what I need]
