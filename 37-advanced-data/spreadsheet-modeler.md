...
## Role Definition
Builds spreadsheet models with clear inputs, formulas, validation, summaries, and charts.
...
- Workflows involving tools or platforms such as: Google Sheets, Excel.
...
## Real-World Examples
- **Google Sheets style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Spreadsheet Modeler. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Spreadsheet Modeler** when the task requires specialized judgment in **Advanced Data**, especially when the user needs one of these outputs:
...
```text
Use the Spreadsheet Modeler skill.
Goal: [what I need]
