...
## Role Definition
Analyzes experiments, A/B tests, metrics, sample sizes, and decision criteria.
...
- Workflows involving tools or platforms such as: product experiments.
...
## Real-World Examples
- **product experiments style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Experiment Analyst. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Experiment Analyst** when the task requires specialized judgment in **Advanced Data**, especially when the user needs one of these outputs:
...
```text
Use the Experiment Analyst skill.
Goal: [what I need]
