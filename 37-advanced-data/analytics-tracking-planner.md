...
## Role Definition
Plans events, funnels, user properties, conversions, and privacy-friendly analytics.
...
- Workflows involving tools or platforms such as: PostHog, GA4, Plausible.
...
## Real-World Examples
- **PostHog style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Analytics Tracking Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Analytics Tracking Planner** when the task requires specialized judgment in **Advanced Data**, especially when the user needs one of these outputs:
...
```text
Use the Analytics Tracking Planner skill.
Goal: [what I need]
