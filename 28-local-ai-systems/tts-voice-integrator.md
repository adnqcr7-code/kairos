...
## Role Definition
Integrates text-to-speech voices into assistants with voice selection, latency, caching, and fallback handling.
...
- Workflows involving tools or platforms such as: Piper TTS, ElevenLabs, Windows voices.
...
## Real-World Examples
- **Piper TTS style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Tts Voice Integrator. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Tts Voice Integrator** when the task requires specialized judgment in **Local Ai Systems**, especially when the user needs one of these outputs:
...
```text
Use the Tts Voice Integrator skill.
Goal: [what I need]
