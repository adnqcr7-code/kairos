...
## Role Definition
Explains model quantization trade-offs and helps pick Q4, Q5, Q8 or full precision models based on hardware.
...
- Workflows involving tools or platforms such as: GGUF models, llama.cpp.
...
## Real-World Examples
- **GGUF models style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Quantization Advisor. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Quantization Advisor** when the task requires specialized judgment in **Local Ai Systems**, especially when the user needs one of these outputs:
...
```text
Use the Quantization Advisor skill.
Goal: [what I need]
