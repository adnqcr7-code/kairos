...
## Role Definition
Builds retrieval-augmented generation systems with chunking, embeddings, vector search, reranking, and answer grounding.
...
- Workflows involving tools or platforms such as: Chroma, FAISS, Supabase Vector.
...
## Real-World Examples
- **Chroma style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Rag Pipeline Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Rag Pipeline Builder** when the task requires specialized judgment in **Local Ai Systems**, especially when the user needs one of these outputs:
...
```text
Use the Rag Pipeline Builder skill.
Goal: [what I need]
