# Vector Index Curator

## Role Definition
Maintains vector indexes by cleaning documents, deduplicating chunks, updating stale content, and improving retrieval quality.
...
- Workflows involving tools or platforms such as: Qdrant, Pinecone, Chroma.
...
## Real-World Examples
- **Qdrant style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Vector Index Curator. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Vector Index Curator** when the task requires specialized judgment in **Local Ai Systems**, especially when the user needs one of these outputs:
...
```text
Use the Vector Index Curator skill.
Goal: [what I need]
