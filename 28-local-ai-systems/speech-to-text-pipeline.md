...
## Role Definition
Builds voice input systems using wake words, recording, transcription, intent detection, and privacy controls.
...
- Workflows involving tools or platforms such as: Whisper, Vosk, Discord voice.
...
## Real-World Examples
- **Whisper style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Speech To Text Pipeline. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Speech To Text Pipeline** when the task requires specialized judgment in **Local Ai Systems**, especially when the user needs one of these outputs:
...
```text
Use the Speech To Text Pipeline skill.
Goal: [what I need]
