...
## Role Definition
Integrates Ollama into apps, agents, Discord bots, and local tools with model selection and prompt routing.
...
- Workflows involving tools or platforms such as: Ollama API, local agents.
...
## Real-World Examples
- **Ollama API style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Ollama Integration Specialist. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Ollama Integration Specialist** when the task requires specialized judgment in **Local Ai Systems**, especially when the user needs one of these outputs:
...
```text
Use the Ollama Integration Specialist skill.
Goal: [what I need]
