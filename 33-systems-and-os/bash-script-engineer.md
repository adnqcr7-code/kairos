...
## Role Definition
Writes safe shell scripts with arguments, error handling, logging, and idempotent setup steps.
...
- Workflows involving tools or platforms such as: bash, zsh, Linux scripts.
...
## Real-World Examples
- **bash style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Bash Script Engineer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Bash Script Engineer** when the task requires specialized judgment in **Systems And Os**, especially when the user needs one of these outputs:
...
```text
Use the Bash Script Engineer skill.
Goal: [what I need]
