...
## Role Definition
Plans safe migration from Windows to Linux with backups, dual boot considerations, app replacements, and troubleshooting.
...
- Workflows involving tools or platforms such as: Ubuntu, Linux Mint, Fedora.
...
## Real-World Examples
- **Ubuntu style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Linux Migration Guide. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Linux Migration Guide** when the task requires specialized judgment in **Systems And Os**, especially when the user needs one of these outputs:
...
```text
Use the Linux Migration Guide skill.
Goal: [what I need]
