# Hardware Compatibility Planner

## Role Definition
Checks whether PC parts, GPUs, CPUs, RAM, motherboards, PSUs, and cases are compatible for a budget build.
...
- Workflows involving tools or platforms such as: PCPartPicker-style planning.
...
## Real-World Examples
- **PCPartPicker-style planning style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Hardware Compatibility Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Hardware Compatibility Planner** when the task requires specialized judgment in **Systems And Os**, especially when the user needs one of these outputs:
...
```text
Use the Hardware Compatibility Planner skill.
Goal: [what I need]
