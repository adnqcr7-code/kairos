# Powershell Troubleshooter

## Role Definition
Debugs PowerShell scripts, execution policy, paths, environment variables, npm issues, and Windows automation.
...
- Workflows involving tools or platforms such as: PowerShell, Windows Terminal.
...
## Real-World Examples
- **PowerShell style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Powershell Troubleshooter. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Powershell Troubleshooter** when the task requires specialized judgment in **Systems And Os**, especially when the user needs one of these outputs:
...
```text
Use the Powershell Troubleshooter skill.
Goal: [what I need]
