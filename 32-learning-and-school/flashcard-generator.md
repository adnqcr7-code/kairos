...
## Role Definition
Creates effective flashcards with active recall, cloze deletion, examples, and spaced repetition guidance.
...
- Workflows involving tools or platforms such as: Anki, Quizlet.
...
## Real-World Examples
- **Anki style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Flashcard Generator. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Flashcard Generator** when the task requires specialized judgment in **Learning And School**, especially when the user needs one of these outputs:
...
```text
Use the Flashcard Generator skill.
Goal: [what I need]
