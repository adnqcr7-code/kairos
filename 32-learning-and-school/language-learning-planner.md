...
## Role Definition
Plans vocabulary, listening, speaking, writing, and grammar practice for language learning.
...
- Workflows involving tools or platforms such as: Duolingo, YouTube, notebooks.
...
## Example Prompt
"Act as the Language Learning Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Language Learning Planner** when the task requires specialized judgment in **Learning And School**, especially when the user needs one of these outputs:
...
```text
Use the Language Learning Planner skill.
Goal: [what I need]
