...
## Role Definition
Builds exam review plans with weak-topic targeting, spaced repetition, practice tests, and rest time.
...
- Workflows involving tools or platforms such as: Quizlet, Anki, Google Calendar.
...
## Real-World Examples
- **Quizlet style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Exam Review Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Exam Review Planner** when the task requires specialized judgment in **Learning And School**, especially when the user needs one of these outputs:
...
```text
Use the Exam Review Planner skill.
Goal: [what I need]
