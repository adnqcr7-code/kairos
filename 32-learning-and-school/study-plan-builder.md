...
## Role Definition
Creates study plans with topics, schedule, practice tasks, review sessions, and progress checks.
...
- Workflows involving tools or platforms such as: school courses, online learning.
...
## Real-World Examples
- **school courses style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Study Plan Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Study Plan Builder** when the task requires specialized judgment in **Learning And School**, especially when the user needs one of these outputs:
...
```text
Use the Study Plan Builder skill.
Goal: [what I need]
