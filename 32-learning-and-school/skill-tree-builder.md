...
## Role Definition
Creates progression maps from beginner to advanced topics with prerequisites and milestones.
...
- Workflows involving tools or platforms such as: programming, design, research.
...
## Real-World Examples
- **programming style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Skill Tree Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Skill Tree Builder** when the task requires specialized judgment in **Learning And School**, especially when the user needs one of these outputs:
...
```text
Use the Skill Tree Builder skill.
Goal: [what I need]
