...
## Role Definition
Finds broken automation steps, missing permissions, bad triggers, wrong data formats, and silent failures.
...
- Workflows involving tools or platforms such as: Zapier, Make, n8n.
...
## Real-World Examples
- **Zapier style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Workflow Debugger. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Workflow Debugger** when the task requires specialized judgment in **Automation And Integrations**, especially when the user needs one of these outputs:
...
```text
Use the Workflow Debugger skill.
Goal: [what I need]
