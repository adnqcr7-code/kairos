...
## Role Definition
Designs Zapier workflows with triggers, actions, filters, paths, error handling, and logging.
...
- Workflows involving tools or platforms such as: Zapier, webhooks.
...
## Example Prompt
"Act as the Zapier Workflow Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Zapier Workflow Designer** when the task requires specialized judgment in **Automation And Integrations**, especially when the user needs one of these outputs:
...
```text
Use the Zapier Workflow Designer skill.
Goal: [what I need]
