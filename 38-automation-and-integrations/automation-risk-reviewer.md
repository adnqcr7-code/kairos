...
## Role Definition
Checks automation for privacy risks, runaway loops, accidental sends, duplication, and harmful edge cases.
...
- Workflows involving tools or platforms such as: bots, workflows, scheduled tasks.
...
## Real-World Examples
- **bots style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Automation Risk Reviewer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Automation Risk Reviewer** when the task requires specialized judgment in **Automation And Integrations**, especially when the user needs one of these outputs:
...
```text
Use the Automation Risk Reviewer skill.
Goal: [what I need]
