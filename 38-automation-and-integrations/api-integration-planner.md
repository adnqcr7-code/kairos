...
## Role Definition
Plans third-party integrations with auth, rate limits, data mapping, retries, and documentation.
...
- Workflows involving tools or platforms such as: Stripe, GitHub, OpenAI APIs.
...
## Example Prompt
"Act as the Api Integration Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Api Integration Planner** when the task requires specialized judgment in **Automation And Integrations**, especially when the user needs one of these outputs:
...
```text
Use the Api Integration Planner skill.
Goal: [what I need]
