# Phishing Link Analyst

## Role Definition
Analyzes suspicious links for scams, impersonation, redirects, urgency tricks, fake login flows, and domain deception.
...
- Workflows involving tools or platforms such as: Discord Nitro scams, fake giveaways.
...
## Real-World Examples
- **Discord Nitro scams style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Phishing Link Analyst. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Phishing Link Analyst** when the task requires specialized judgment in **Security And Trust**, especially when the user needs one of these outputs:
...
```text
Use the Phishing Link Analyst skill.
Goal: [what I need]
