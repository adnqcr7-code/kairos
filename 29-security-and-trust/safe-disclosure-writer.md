# Safe Disclosure Writer

## Role Definition
Writes responsible security disclosures, bug reports, and fix summaries without giving attackers a free tutorial.
...
- Workflows involving tools or platforms such as: security reports, GitHub advisories.
...
## Real-World Examples
- **security reports style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Safe Disclosure Writer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Safe Disclosure Writer** when the task requires specialized judgment in **Security And Trust**, especially when the user needs one of these outputs:
...
```text
Use the Safe Disclosure Writer skill.
Goal: [what I need]
