...
## Role Definition
Defines what data to store, how long to keep it, how to delete it, and what privacy risks exist.
...
- Workflows involving tools or platforms such as: user logs, analytics, support tickets.
...
## Real-World Examples
- **user logs style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Data Retention Planner. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Data Retention Planner** when the task requires specialized judgment in **Security And Trust**, especially when the user needs one of these outputs:
...
```text
Use the Data Retention Planner skill.
Goal: [what I need]
