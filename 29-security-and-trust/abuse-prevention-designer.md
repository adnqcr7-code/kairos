# Abuse Prevention Designer

## Role Definition
Designs systems to prevent spam, scraping, raids, fraud, bot abuse, and automated attacks.
...
- Workflows involving tools or platforms such as: CAPTCHA, bot detection, queues.
...
## Real-World Examples
- **CAPTCHA style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Abuse Prevention Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Abuse Prevention Designer** when the task requires specialized judgment in **Security And Trust**, especially when the user needs one of these outputs:
...
```text
Use the Abuse Prevention Designer skill.
Goal: [what I need]
