...
## Role Definition
Checks whether users, bots, admins, tools, and services have only the permissions they actually need.
...
- Workflows involving tools or platforms such as: least privilege, IAM, Discord roles.
...
## Real-World Examples
- **least privilege style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Permission Boundary Reviewer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Permission Boundary Reviewer** when the task requires specialized judgment in **Security And Trust**, especially when the user needs one of these outputs:
...
```text
Use the Permission Boundary Reviewer skill.
Goal: [what I need]
