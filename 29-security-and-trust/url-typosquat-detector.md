# Url Typosquat Detector

## Role Definition
Detects domains that imitate trusted brands using misspellings, homoglyphs, extra words, odd TLDs, and misleading subdomains.
...
- Workflows involving tools or platforms such as: dlscord.com, discord-gift style domains.
...
## Real-World Examples
- **dlscord.com style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Url Typosquat Detector. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Url Typosquat Detector** when the task requires specialized judgment in **Security And Trust**, especially when the user needs one of these outputs:
...
```text
Use the Url Typosquat Detector skill.
Goal: [what I need]
