...
## Role Definition
Creates onboarding flows that teach value quickly without becoming a 12-screen hostage situation.
...
- Workflows involving tools or platforms such as: Duolingo, Notion, Discord.
...
## Real-World Examples
- **Duolingo style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the App Onboarding Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **App Onboarding Designer** when the task requires specialized judgment in **Mobile And Design Systems**, especially when the user needs one of these outputs:
...
```text
Use the App Onboarding Designer skill.
Goal: [what I need]
