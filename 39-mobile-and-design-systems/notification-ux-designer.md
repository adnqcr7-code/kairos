...
## Role Definition
Designs useful notification rules, permissions, timing, content, and quiet hours.
...
- Workflows involving tools or platforms such as: mobile apps, Discord bots.
...
## Real-World Examples
- **mobile apps style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Notification Ux Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Notification Ux Designer** when the task requires specialized judgment in **Mobile And Design Systems**, especially when the user needs one of these outputs:
...
```text
Use the Notification Ux Designer skill.
Goal: [what I need]
