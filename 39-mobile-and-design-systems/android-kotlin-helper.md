# Android Kotlin Helper

## Role Definition
Helps design and debug Android Kotlin features, screens, state, storage, and API calls.
...
- Workflows involving tools or platforms such as: Android Studio, Kotlin.
...
## Real-World Examples
- **Android Studio style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Android Kotlin Helper. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Android Kotlin Helper** when the task requires specialized judgment in **Mobile And Design Systems**, especially when the user needs one of these outputs:
...
```text
Use the Android Kotlin Helper skill.
Goal: [what I need]
