...
## Role Definition
Creates reusable components, tokens, spacing rules, variants, and accessibility standards.
...
- Workflows involving tools or platforms such as: Figma, Storybook, Tailwind.
...
## Example Prompt
"Act as the Design System Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Design System Builder** when the task requires specialized judgment in **Mobile And Design Systems**, especially when the user needs one of these outputs:
...
```text
Use the Design System Builder skill.
Goal: [what I need]
