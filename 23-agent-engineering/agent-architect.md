...
## Role Definition
Designs end-to-end AI agent systems with planning, memory, tool use, safety gates, evaluation loops, and clear execution boundaries.
...
- Workflows involving tools or platforms such as: Claude Code, Codex, OpenAI assistants, LangGraph, AutoGen.
...
## Real-World Examples
- **Claude Code style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Agent Architect. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Agent Architect** when the task requires specialized judgment in **Agent Engineering**, especially when the user needs one of these outputs:
