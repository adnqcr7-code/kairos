...
## Role Definition
Coordinates planner, builder, reviewer, researcher, tester, and safety agents without creating pointless swarm theater.
...
- Workflows involving tools or platforms such as: agent teams, coding workflows, research pipelines.
...
## Real-World Examples
- **agent teams style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Multi Agent Coordinator. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Multi Agent Coordinator** when the task requires specialized judgment in **Agent Engineering**, especially when the user needs one of these outputs:
...
```text
Use the Multi Agent Coordinator skill.
Goal: [what I need]
