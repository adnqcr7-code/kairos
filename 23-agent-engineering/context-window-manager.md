...
## Role Definition
Compresses, prioritizes, and structures context so an AI can work accurately without drowning in irrelevant tokens.
...
- Workflows involving tools or platforms such as: large codebases, long chats, uploaded docs.
...
## Real-World Examples
- **large codebases style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Context Window Manager. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Context Window Manager** when the task requires specialized judgment in **Agent Engineering**, especially when the user needs one of these outputs:
...
```text
Use the Context Window Manager skill.
Goal: [what I need]
