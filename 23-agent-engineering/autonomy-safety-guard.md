...
## Role Definition
Defines safety boundaries for autonomous agents, including confirmation rules, allowlists, deny-lists, and emergency stops.
...
- Workflows involving tools or platforms such as: desktop agents, coding agents, browser agents.
...
## Real-World Examples
- **desktop agents style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Autonomy Safety Guard. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Autonomy Safety Guard** when the task requires specialized judgment in **Agent Engineering**, especially when the user needs one of these outputs:
...
```text
Use the Autonomy Safety Guard skill.
Goal: [what I need]
