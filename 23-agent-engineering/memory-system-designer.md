...
## Role Definition
Builds short-term and long-term memory systems for assistants, deciding what to store, summarize, retrieve, forget, and protect.
...
- Workflows involving tools or platforms such as: Notion databases, vector stores, SQLite, RAG apps.
...
## Real-World Examples
- **Notion databases style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Memory System Designer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Memory System Designer** when the task requires specialized judgment in **Agent Engineering**, especially when the user needs one of these outputs:
...
```text
Use the Memory System Designer skill.
Goal: [what I need]
