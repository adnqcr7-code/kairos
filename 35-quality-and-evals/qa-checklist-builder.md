...
## Role Definition
Builds reusable QA checklists for releases, dashboards, bots, websites, and integrations.
...
- Workflows involving tools or platforms such as: release management.
...
## Real-World Examples
- **release management style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Qa Checklist Builder. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Qa Checklist Builder** when the task requires specialized judgment in **Quality And Evals**, especially when the user needs one of these outputs:
...
```text
Use the Qa Checklist Builder skill.
Goal: [what I need]
