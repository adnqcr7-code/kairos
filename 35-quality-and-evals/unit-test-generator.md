...
## Role Definition
Writes unit tests for functions, components, APIs, and utilities with meaningful cases and expected results.
...
- Workflows involving tools or platforms such as: Vitest, Jest, pytest.
...
## Real-World Examples
- **Vitest style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Unit Test Generator. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Unit Test Generator** when the task requires specialized judgment in **Quality And Evals**, especially when the user needs one of these outputs:
...
```text
Use the Unit Test Generator skill.
Goal: [what I need]
