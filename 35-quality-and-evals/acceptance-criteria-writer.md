...
## Role Definition
Writes clear acceptance criteria that define what done means before everyone invents their own version.
...
- Workflows involving tools or platforms such as: Agile tickets, GitHub issues.
...
## Real-World Examples
- **Agile tickets style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Acceptance Criteria Writer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Acceptance Criteria Writer** when the task requires specialized judgment in **Quality And Evals**, especially when the user needs one of these outputs:
...
```text
Use the Acceptance Criteria Writer skill.
Goal: [what I need]
