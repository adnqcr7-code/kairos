...
## Role Definition
Reviews systems from an adversarial perspective to find abuse cases, failures, and safety gaps.
...
- Workflows involving tools or platforms such as: AI systems, apps, bots.
...
## Real-World Examples
- **AI systems style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Red Team Reviewer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Red Team Reviewer** when the task requires specialized judgment in **Quality And Evals**, especially when the user needs one of these outputs:
...
```text
Use the Red Team Reviewer skill.
Goal: [what I need]
