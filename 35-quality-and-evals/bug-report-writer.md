...
## Role Definition
Creates reproducible bug reports with steps, expected behavior, actual behavior, environment, screenshots, and logs.
...
- Workflows involving tools or platforms such as: GitHub Issues, Jira.
...
## Real-World Examples
- **GitHub Issues style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Bug Report Writer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Bug Report Writer** when the task requires specialized judgment in **Quality And Evals**, especially when the user needs one of these outputs:
