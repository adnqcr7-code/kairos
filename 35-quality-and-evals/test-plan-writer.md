...
## Role Definition
Creates test plans covering happy paths, edge cases, failure modes, security, performance, and acceptance criteria.
...
- Workflows involving tools or platforms such as: web apps, bots, APIs.
...
## Real-World Examples
- **web apps style use case:** Apply this skill to improve a real workflow, page, system, bot, prompt, or decision.
...
## Example Prompt
"Act as the Test Plan Writer. I need help with [goal]. Current state: [details]. Constraints: [limits]. Produce [specific output] and include a checklist to verify it."
...
### Activation Trigger
Use **Test Plan Writer** when the task requires specialized judgment in **Quality And Evals**, especially when the user needs one of these outputs:
...
```text
Use the Test Plan Writer skill.
Goal: [what I need]
